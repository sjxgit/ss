 ...
 <div id="container" style="margin-top: 10px;">
	 ...
	 <table class="table" width="100%">
		 ...
		 <tr>
			 ...
			 <td>
				 <input class="easyui-textbox"  id="column" name="columntype" placeHolder="你点我查" readonly="readonly"/></td>
		 ...
		 <tr>
			 ...
			 <td class="input"><form action="${pageContext.request.contextPath}/news/upload.do" enctype="multipart/form-data">
